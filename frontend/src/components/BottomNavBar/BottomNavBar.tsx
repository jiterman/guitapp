...
const BottomNavBar: React.FC = () => {
  ...
  return (
    <View style={styles.container} accessibilityRole="tablist">
      <Pressable style={styles.button} onPress={() => router.push('/home')} accessibilityRole="button">
        <SvgXml xml={HOME_ICON} width={24} height={24} />
      </Pressable>
      <Pressable style={styles.button} onPress={() => router.push('/transactions')} accessibilityRole="button">
        <SvgXml xml={LIST_ICON} width={24} height={24} />
      </Pressable>
      <Pressable style={styles.button} onPress={() => router.push('/more')} accessibilityRole="button">
        <SvgXml xml={MORE_ICON} width={24} height={24} />
      </Pressable>
      <Pressable style={styles.button} onPress={() => router.push('/profile')} accessibilityRole="button">
