...
class AlertDeliveryServiceTest {
    ...
    @Test
    void deliverAlert_ShouldSaveAndSendImmediately_WhenFrequencyIsInstant() {
    ...
    @Test
    void deliverAlert_ShouldSaveWithoutPush_WhenFrequencyIsDaily() {
    ...
    @Test
    void deliverAlert_ShouldSaveWithoutPush_WhenFrequencyIsWeekly() {
    ...
    @Test
    void deliverAlert_ShouldSaveWithoutPush_WhenFrequencyIsDaily_AndNotSummaryType() {
        testUser.setNotificationFrequency(NotificationFrequency.DAILY);
