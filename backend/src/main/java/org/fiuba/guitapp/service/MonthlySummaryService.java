...
public class MonthlySummaryService {
    ...
    private MonthlySummaryResponse buildSummary(
        ...
        List<MonthlyCategoryBreakdown> categoryBreakdown = buildCategoryBreakdown(expenses, totalExpenses, prevExpenses);

        List<Expense> variableExpenses = expenses
                .stream()
                .filter(
                        expense -> expense.getType() == null ||
        ...
        return expenses
                ...
                .sorted(
                        Comparator.comparing(
                                MonthlyCategoryBreakdown::totalAmount).reversed())
                .toList();
    }
    ...
    private List<MonthlyInsight> buildInsights(
        ...
        categoryBreakdown
                .stream()
                .filter(
                        c -> c.changeVsPreviousMonth() != null &&
        ...
        if (totalExpenses.compareTo(BigDecimal.ZERO) > 0) {
            ...
            String highlight = String.format(
                    ...
                    "%.0f%%",
                    nonEssentialPct);
            String variant = nonEssentialPct <= 20
                    ? "positive"
                    : nonEssentialPct <= 30
                            ? "neutral"
                            : "negative";
    ...
    private java.util.Optional<MonthlyInsight> buildWeekdayCategoryInsight(
        ...
        return variableExpenses
                ...
                .map(entry -> {
                    ...
                    java.util.Map<java.time.DayOfWeek, BigDecimal> byDay = variableExpenses
                            .stream()
                    ...
                    java.util.Map.Entry<java.time.DayOfWeek, BigDecimal> topDay = byDay
                            .entrySet()
                            .stream()
    ...
    private java.util.Optional<MonthlyInsight> buildWeeklyVariableInsight(
        ...
        java.util.Map<LocalDate, BigDecimal> sumByWeekStart = new java.util.HashMap<>();
        java.util.Map<LocalDate, java.util.Set<java.time.DayOfWeek>> daysByWeekStart = new java.util.HashMap<>();
        ...
        return sumByWeekStart
                ...
                .map(entry -> {
                    ...
                    BigDecimal amount = entry.getValue();
                    java.util.Set<java.time.DayOfWeek> days = daysByWeekStart.getOrDefault(weekStart, java.util.Set.of());
                    if (days.size() <= 1) {
                        return null;
                    }
